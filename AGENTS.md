...
| `trackNameChanges`       | SangMata-style name/@username change notices                                              | `nameChangeTracker` message handler · **rider:** the CSAM bio rotation reuses its `getChat`/`getChatMember` responses |
